...
class GraphConvolution(torch.nn.Module):
    ...
    def __init__(self, in_features, out_features, mesh='body', bias=True):
        ...
        adj_indices = torch.load('./src2/data/mano_195_adjmat_indices.pt')
        adj_mat_value = torch.load('./src2/data/mano_195_adjmat_values.pt')
        adj_mat_size = torch.load('./src2/data/mano_195_adjmat_size.pt')
